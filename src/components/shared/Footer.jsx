    ...
    <div>
      <footer className="bg-gray-800 text-white py-7">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
            <div>
              <h3 className="text-lg font-bold mb-4">Job Hunt</h3>
              <p>Your one-stop platform for all your job search needs.</p>
            </div>
            <div>
              <h3 className="text-lg font-bold mb-4">Contact Us</h3>
              <ul className="space-y-2">
                <li>Email: info@jobhunt.com</li>
                <li>Phone: +123-456-7890</li>
                <li>Address: 123 Job Street, Delhi</li>
              </ul>
              <div className="mt-4">
