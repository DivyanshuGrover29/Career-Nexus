...
const UpdateProfileDialog = ({ open, setOpen }) => {
  ...
  //skills map krva kar array me rkhi
  ...
  //same hmne signup login me se copy kra
  ...
  const submitHandler = async (e) => {
    e.preventDefault();// we write this because page refresh na ho
    ...
    try {
      //upar hmne locally loading create kri so islie yaha dispatch use ni kra and loading true krdi
      setLoading(true);
