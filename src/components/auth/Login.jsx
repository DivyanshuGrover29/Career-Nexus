          ...
          <div className="radio-button">
            <RadioGroup className="flex items-center gap-4 my-5">
              ...
              <Input 
                    ...
                    checked={input.role==='Undergraduate Student'}
                    onChange={changeEventHandler}
                    className="cursor-pointer w-4 h-4"  
                  />
                <Label htmlFor="option-one">Undergraduate Student</Label>
              </div>
              <div className="flex items-center space-x-2">
              <Input 
                    type="radio" 
                    ...
                    checked={input.role==='Postgraduate Student'}
                    onChange={changeEventHandler}
                    className="cursor-pointer w-4 h-4"  
                  />
                <Label htmlFor="option-two">Postgraduate Student</Label>
              </div>
            </RadioGroup>
          </div>
          {
